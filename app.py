...
def predict():
    ...
    if request.method == 'POST':
        ...
        if output<0:
            ...
            return render_template('result.html',your_name='{}'.format(Name),your_contact_no='{}'.format(Contact),your_brand='{}'.format(Brand),your_model='{}'.format(Model),prediction_text="{}".format(output))
    else:
